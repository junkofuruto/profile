import { Component, createEffect, createMemo, createResource, createSignal, onCleanup, onMount, Suspense } from "solid-js";
        ...
        <Suspense fallback={<LoadingScreen />}>
            ...
            <section>
                <div class="absolute flex items-center justify-center h-screen z-0">
                    <div class="font-michroma text-white justify-center max-w-[800px] md:ml-[20%] md:text-[48px] md:text-left text-center ml-2 text-[20px]">
